// ============================================================
// Claude (Anthropic) helpers — outreach drafting and scoring assist. Mirrors
// the prompting patterns already proven out in PO-outreach-app's
// lib/claude.ts, adapted to REI Grove's partnership + affiliate/creator
// outreach voice (see rei-grove-content.ts and the partnership-prospector /
// affiliate-prospector skills this was ported from).
// ============================================================
