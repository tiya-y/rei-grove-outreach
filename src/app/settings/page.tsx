...
export default function SettingsPage() {
  const { data, loading } = useSWRLike<SettingsResponse>('/api/settings');
    ...
    <div className="max-w-3xl space-y-8">
      ...
      <div className="card space-y-3">
        ...
        <p className="text-sm text-gray-500">
          Point an n8n discovery workflow at this endpoint to bulk-import prospects. Every request must include header{' '}
          <code className="rounded bg-gray-100 px-1">x-n8n-secret</code> matching your{' '}
          <code className="rounded bg-gray-100 px-1">N8N_WEBHOOK_SECRET</code> env var.
        </p>
